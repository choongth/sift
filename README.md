...
![Python](https://img.shields.io/badge/Python-3.11-blue) ![Chainlit](https://img.shields.io/badge/Chainlit-2.11-green) ![AWS Bedrock](https://img.shields.io/badge/AWS-Bedrock-orange) ![Docker](https://img.shields.io/badge/Docker-Compose-blue)
...
2. **Sift plans** a structured approach — research questions and search queries.
...
6. **Report is saved** locally as Markdown and uploaded to S3 with a presigned download link.
...
| PDF parsing | PyMuPDF |
| UI | Chainlit 2.11 |
| Report storage | AWS S3 (presigned download URLs) |
...
**Two-phase loop** — Phase 1 forces a structured plan via `tool_choice`. The plan is injected into the system prompt for Phase 2, giving Claude direction before it starts searching.
